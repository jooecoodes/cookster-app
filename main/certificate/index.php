...
if (isset($_SESSION['userId'])) {
    if (isset($_SESSION['userCertEligible']) && $_SESSION['userCertEligible'] == 1) {
...
?>
        ...
        <body>
            <div id="center-div">
                ...
                <a href="../profile/">Get back to profile</a>
            </div>
            <script>
...
<?php
        ...
        echo "You're not eligible to get the certificate, take the quiz first";
    }
} else {
